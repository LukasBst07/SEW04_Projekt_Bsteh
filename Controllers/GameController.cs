...
namespace SEW04_Projekt_Bsteh.Controllers
{
    ...
    public class GameController : Controller
    {
        ...
        private static decimal CalculateUpgradeCost(decimal baseCost, int currentLevel, double discount)
        {
            var cost = baseCost * (decimal)(currentLevel + 1) * 0.75m;
            if (cost < 100) cost = 100m * (decimal)(currentLevel + 1);
            cost *= (1 - (decimal)discount);
            return cost;
        }
        ...
        public async Task<IActionResult> UpgradeBuilding(int buildingId, string upgradeType)
        {
            ...
            var cost = CalculateUpgradeCost(userBuilding.Building.BaseCost, currentLevel, farm.AchievementUpgradeDiscount);
            ...
            switch (upgradeType)
            {
                ...
                case "capacity":
                    ...
                    {
                        outputResource.MaxStorage = 100 * (1 + userBuilding.CapacityLevel * 0.20)
